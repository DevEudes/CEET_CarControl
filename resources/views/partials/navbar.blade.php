...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul>
            <li class="nav-item nav-search d-none d-lg-block" style="color: #000; margin-top: 20px">
                @if (Route::has('login'))
                    @auth
                        @role('admin|chef_service')
                        ...
                        @endrole
                        <a href="{{ route('logout') }}" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20]"
